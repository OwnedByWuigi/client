...
function SendPhotos1()
{
	...
	try
	{
		...
		if(!IsInRotatedImageList(srcURL))
		{
			...
			if(IsOnlineDevice()){
				if (srcURL.indexOf("?t=")== -1){
					var skyToken =  TVShell.Property.Item("SkyToken");
					if(skyToken && skyToken!="")
						srcURL = srcURL +"?"+ skyToken;
					else
						throw "tokenError";
				}
	...
	{
		if (ex =="tokenError")
			TVShell.Message("PhotosNavigate.js: SendPhoto1:Error Got exception - failed to get SkyDrive token")
		else
